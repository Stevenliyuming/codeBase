...
(function (codeBase) {
    ...
    var ListGroup = (function (_super) {
        ...
        ListGroup.prototype.addItem = function (item) {
            ...
            item.addEventListener(codeBase.BasicUIEvent.TOUCH_BEGIN, s.onTouch, s);
            item.addEventListener(codeBase.BasicUIEvent.TOUCH_END, s.onTouch, s);
            s.items.push(item);
        };
        ListGroup.prototype.removeItem = function (item) {
            ...
            if (s.contentView.contains(item)) {
                ...
                item.removeEventListener(codeBase.BasicUIEvent.TOUCH_BEGIN, s.onTouch, s);
                item.removeEventListener(codeBase.BasicUIEvent.TOUCH_END, s.onTouch, s);
        ...
        ListGroup.prototype.onTouch = function (e) {
            var s = this;
            if (e.type == codeBase.BasicUIEvent.TOUCH_BEGIN) {
