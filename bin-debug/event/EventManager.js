    ...
    var EventManager = (function () {
        ...
        EventManager.getEvent = function (type) {
            ...
            if (eventArray.length == 0) {
                return new codeBase.MyEvent(type);
            }
        ...
        */
        EventManager.dispactchPacket = function (packet) {
            if (packet != null) {
                codeBase.Debug.log = packet;
                this.packetSendCacheList.push(packet);
                codeBase.HeartBeat.addListener(EventManager, EventManager.onFireDispactchPacket);
            }
            ;
        };
        /**
        ...
        EventManager.onFireDispactchPacket = function () {
            if (EventManager.packetSendCacheList.length > 0) {
                ...
                //优先handle处理数据
                codeBase.MessageControler.receivePacket(packet);
            ...
            if (this.packetSendCacheList.length == 0) {
                codeBase.HeartBeat.removeListener(EventManager, EventManager.onFireDispactchPacket);
            }
        };
        //////////////////////////////////////////////
        /**
        ...
        EventManager.dispatchEvent = function (e) {
            if (e != null) {
                ...
                codeBase.HeartBeat.addListener(EventManager, EventManager.onFiredispatchEvent);
            }
        };
        /**
         * 队列派发事件
        ...
        EventManager.onFiredispatchEvent = function () {
            if (EventManager.eventSendCacheList.length > 0) {
                ...
                codeBase.MessageControler.receiveEvent(e);
            ...
            if (EventManager.eventSendCacheList.length == 0) {
                codeBase.HeartBeat.removeListener(EventManager, EventManager.onFiredispatchEvent);
            }
        };
        /**
         * 移除事件监听
