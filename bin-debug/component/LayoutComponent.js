...
(function (codeBase) {
    var LayoutComponent = (function (_super) {
         ...
         */
        LayoutComponent.prototype.initData = function () {
            var s = this;
         ...
         * 子类覆写该方法,添加UI逻辑
         */
        LayoutComponent.prototype.createChildren = function () {
        };
        /**分发事件*/
        LayoutComponent.prototype.dispEvent = function (type, data, dataType) {
        ...
        /**帧听事件*/
        LayoutComponent.prototype.addEvent = function (type, listener, thisObj) {
        ...
        /**删除事件*/
        LayoutComponent.prototype.removeEvent = function (type, listener) {
            var s = this;
        ...
        /**把自己从父级删除*/
        LayoutComponent.prototype.removeFromParent = function (value) {
        ...
        /**删除所有的*/
        LayoutComponent.prototype.removeChildAll = function (dispose) {
        ...
        /**删除index层的*/
        LayoutComponent.prototype.removeChildIndex = function (index, dispose) {
            var s = this;
            if (index >= 0 || index < s.numChildren) {
                var basicContent = s.getChildAt(index);
                if (basicContent instanceof LayoutComponent) {
        ...
        /**销毁*/
        LayoutComponent.prototype.dispose = function () {
            var s = this;
    ...
    codeBase.LayoutComponent = LayoutComponent;
    __reflect(LayoutComponent.prototype, "codeBase.LayoutComponent");
})(codeBase || (codeBase = {}));
