...
(function (codeBase) {
    var VehicleSteeringCtrl = (function (_super) {
        ...
        VehicleSteeringCtrl.prototype.onAddedStage = function (e) {
            this.setupUI();
            codeBase.easyP2.KeyManager.init();
            egret.Ticker.getInstance().register(this.update, this); //
        };
        VehicleSteeringCtrl.prototype.setupUI = function () {
            this.btnHor = codeBase.easyP2.DispUtil.createBitmapByName("rect");
            ...
            this.btnVer = codeBase.easyP2.DispUtil.createBitmapByName("rect");
            ...
            this.btnJump = codeBase.easyP2.DispUtil.createBitmapByName("rect");
        ...
        VehicleSteeringCtrl.prototype.update = function () {
            //keyboard ctrl-----------------------
            if (codeBase.easyP2.KeyManager.isDown(codeBase.easyP2.KeyManager.UP)) {
                this.dirV_keyboard = 1;
            }
            else if (codeBase.easyP2.KeyManager.isDown(codeBase.easyP2.KeyManager.DOWN)) {
                this.dirV_keyboard = -1;
            }
            else {
                this.dirV_keyboard = 0;
            }
            if (codeBase.easyP2.KeyManager.isDown(codeBase.easyP2.KeyManager.LEFT)) {
                this.dirH_keyboard = -1;
            }
            else if (codeBase.easyP2.KeyManager.isDown(codeBase.easyP2.KeyManager.RIGHT)) {
                this.dirH_keyboard = 1;
            }
            else {
                this.dirH_keyboard = 0;
            }
            if (codeBase.easyP2.KeyManager.isDown(codeBase.easyP2.KeyManager.SPACE)) {
