module codeBase {
    export class ResManager {
        ...
        private static _canSplit: boolean = false;//是否可以切割
        ...
        private static onLoadingGroupJosnFileComplete(event: RES.ResourceEvent): void {
            ...
            if (RES.isGroupLoaded(ResManager._projectGroup + "_group") && !ResManager._canSplit) {
                ...
                MyEvent.sendEvent(EventType.PROJECT_RES_DOWNLOADED);
            }
        }
        /**
         * 切割材质
         */
        private static splitSpriteSheet(): void {
         ...
         * @param groupNames
         */
        public static loadConfig(url: string, root:string, groupNames: Array<string> = null, listener: any = null, thisObject: any = null): void {
        ...
        private static onCheckLoadGroup(): void {
            ...
            var resItems: Array<RES.ResourceInfo> = null;
