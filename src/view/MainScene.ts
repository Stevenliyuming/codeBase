module codeBase {
	...
	export class MainScene extends BaseScene {
		...
		private showScene() {
			...
			let texNames: string[] = ["hand", "playSound", "restart"];
			for (let i = 0; i < 3; ++i) {
				...
				let img = UICreator.createImage(s.group_play, 100 + i * 320, 200, RES.getRes("comRes_1_json." + texNames[i]));
			...
			checkBox.x = 300;
			checkBox.y = 600;
			checkBox.addEventListener(BasicUIEvent.CHANGE, (e: egret.Event) => {
				console.log(e);
			}, s);
			...
			for (let i = 0; i < 3; ++i) {
				...
				radiobtn1.addEventListener(BasicUIEvent.CHANGE, (e: egret.Event) => {
					console.log(e);
				}, s);
				...
				tab1.addEventListener(BasicUIEvent.CHANGE, (e: egret.Event) => {
					console.log(e);
				}, s);
			}
