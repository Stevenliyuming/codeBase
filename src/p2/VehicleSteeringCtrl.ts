module codeBase{
    export class VehicleSteeringCtrl extends egret.Sprite {
        ...
        private onAddedStage(e: egret.Event): void {
            ...
            easyP2.KeyManager.init();
            egret.Ticker.getInstance().register(this.update, this);//
        }

        private setupUI(): void {
            this.btnHor = easyP2.DispUtil.createBitmapByName("rect");
            ...
            this.btnVer = easyP2.DispUtil.createBitmapByName("rect");
            ...
            this.btnJump = easyP2.DispUtil.createBitmapByName("rect");
        ...
        private update(): void {
            //keyboard ctrl-----------------------
            if (easyP2.KeyManager.isDown(easyP2.KeyManager.UP)) {
                this.dirV_keyboard = 1;
            } else if (easyP2.KeyManager.isDown(easyP2.KeyManager.DOWN)) {
                this.dirV_keyboard = -1;
            } else {
                this.dirV_keyboard = 0;
            }

            if (easyP2.KeyManager.isDown(easyP2.KeyManager.LEFT)) {
                this.dirH_keyboard = -1;
            } else if (easyP2.KeyManager.isDown(easyP2.KeyManager.RIGHT)) {
                this.dirH_keyboard = 1;
            } else {
                this.dirH_keyboard = 0;
            }

            if (easyP2.KeyManager.isDown(easyP2.KeyManager.SPACE)) {
