    ...
    export module easyP2 {
        export class DispUtil {
            ...
            */
             ...
             * @param radius
             */
            public static createCapsule(length: number, radius: number): egret.Sprite {
             ...
             */
            public static createPolygon(pathPts: any[]): egret.Sprite {
                var result = new egret.Sprite();
                var shape = new egret.Shape();
                var i;
             ...
             */
            public static createHeightField(pathPts: any[]): egret.Sprite {
                var result = new egret.Sprite();
                var shape = new egret.Shape();
                var i;
                shape.graphics.lineStyle(1, 0x0000ff);
